...
import pandas as pd
import torch
from run.config import get_config_regression
from run.data_loader import MMDataLoader
from trains import ATIO
from utils import assign_gpu, setup_seed
from trains.mainNets.model import rohydr
...
def ROHYDR_run(
        ...
        model_save_dir="./pretrained", res_save_dir="./result", log_dir="./log",
...
def _run(args, num_workers=4, is_tune=False, from_sena=False):
    ...
    model = getattr(rohydr, 'ROHYDR')(args)
    model = model.cuda()
